 ...
 * Entry manipulator.
 */
class CodeownersNamedOwnerManipulator :
        AbstractElementManipulator<com.github.fantom.codeowners.lang.kind.github.psi.CodeownersNamedOwner>() {

    @Throws(IncorrectOperationException::class)
    override fun handleContentChange(
        owner: com.github.fantom.codeowners.lang.kind.github.psi.CodeownersNamedOwner,
        range: TextRange,
        newContent: String,
    ):
        ...
        return when (val newEntry = PsiTreeUtil.findChildOfType(
                file,
