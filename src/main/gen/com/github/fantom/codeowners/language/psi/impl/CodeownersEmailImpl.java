...
public class CodeownersEmailImpl extends ASTWrapperPsiElement implements CodeownersEmail {

  public CodeownersEmailImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CodeownersDomain getDomain() {
    return findNotNullChildByClass(CodeownersDomain.class);
  }

  @Override
  @NotNull
  public CodeownersUsername getUsername() {
    return findNotNullChildByClass(CodeownersUsername.class);
  }
