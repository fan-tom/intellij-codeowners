...
public class CodeownersTeamNameImpl extends ASTWrapperPsiElement implements CodeownersTeamName {

  public CodeownersTeamNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CodeownersVisitor visitor) {
    visitor.visitTeamName(this);
  }
